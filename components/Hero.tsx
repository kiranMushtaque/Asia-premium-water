...
//       desc: "Affordable drinking water in Pakistan — competitive pricing, bulk order discounts and low per-bottle rates.",
...
//                 className={`relative overflow-hidden bg-white rounded-3xl border-2 border-transparent shadow-md transition-all duration-500 transform hover:-translate-y-1 hover:shadow-xl cursor-pointer scale-100`}
//                 tabIndex={0}
//                 aria-labelledby={`feature-${i}`}
//               >
//                 <div className={`relative p-8 z-10`}>
//                   <div
//                     className={`${item.bgColor} w-24 h-24 mx-auto mb-6 rounded-3xl flex items-center justify-center shadow-md transition-transform duration-500`}
//                   >
...
//                   <h3
//                     id={`feature-${i}`}
//                     className={`text-2xl font-semibold text-slate-900 text-center mb-3`}
//                   >
//                     {item.title}
//                   </h3>
...
//                   <div className="mt-4 bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 px-3 py-1 rounded-full text-sm font-semibold inline-block mx-auto">
//                     {item.highlight}
//                   </div>
//                 </div>
//               </article>
